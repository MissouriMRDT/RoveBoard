...
{
  return server->write(byteToWrite);
}
...
TcpClient roveEthernet_TcpClient_Init() //doesn't reaaaaaaaally do anything on the tm4c, our internal define doens't need it
{
  TcpClient client;
  return client;
}
