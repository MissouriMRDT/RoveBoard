...
#ifndef ROVEBOARD_PROTOTYPE_API_ROVEPERMAMEM_H_
#define ROVEBOARD_PROTOTYPE_API_ROVEPERMAMEM_H_
...
extern uint16_t rovePermaMem_getFirstAvailableBlock(bool overrideNonZeroBlocks, uint16_t startingBlock);
...
#endif /* ROVEBOARD_PROTOTYPE_API_ROVEPERMAMEM_H_ */
